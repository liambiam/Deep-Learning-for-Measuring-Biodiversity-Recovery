...
def plot_ae_pca_kmeans(features_pca, kmeans_labels, day, save_dir):
    plt.figure(figsize=(12, 10))
    scatter = plt.scatter(features_pca[:, 0], features_pca[:, 1], c=kmeans_labels, cmap='viridis', alpha=0.7)
    plt.xlabel('PCA Component 1')
    plt.ylabel('PCA Component 2')
...
save_dir = r'E:\Results\AE6results\PAM_1'
...
spectrograms, labels = load_spectrograms(all_paths, sample_size=100)
